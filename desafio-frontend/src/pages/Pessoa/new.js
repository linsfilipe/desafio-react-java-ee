...
import { createRequest } from '../../store/modules/pessoa/actions';
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
        ...
        <input type="text" placeholder="Documento" name="documento" maxLength="15" ref={register({ required: true }) } />
        {errors.documento && <small>O Documento é obrigatório</small>}
        <br />

        <input type="date" placeholder="Data de Nascimento" name="dataNascimento" maxLength="15" ref={register({ required: true }) } />
